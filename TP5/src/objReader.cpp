...
//                PRINTVAR( line );
        ...
        if ( line[0] == 'f' )
        {
            ...
            //*********************************************************************
            float p1 = angleAtVertex(vertices[t.v1], vertices[t.v2], vertices[t.v3]);
            normals[t.v1] += n * p1;
            float p2 = angleAtVertex(vertices[t.v2], vertices[t.v1], vertices[t.v3]);
            normals[t.v2] += n * p2;
            float p3 = angleAtVertex(vertices[t.v3], vertices[t.v2], vertices[t.v1]);
            normals[t.v3] += n * p3;
